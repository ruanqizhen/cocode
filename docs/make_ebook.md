...
标题和立意越新颖独特，越出人意料，就越容易吸引人。我之前在网上看过一部小说的章节标题，就比较有吸引力：“刘姥姥之：宝玉少爷爱上我；贾老爷爱上我；皇上爱上我；三体人爱上我；变形金刚爱上我；等等……”当然，这样太哗众取宠也有副作用，就是很多人只会对标题有兴趣，对里面的内容反而不感兴趣。
...
虽然 Docsify 之类的工具上手更快，但对 SEO 并不友好。我们选择 **Docusaurus**，虽然稍微麻烦一点，但是搜索友好、可扩展性强。
...
Markdown 的哲学是专注内容而非排版。对 AI 友好，对 Git 友好，对 Docusaurus 友好，对搜索引擎也友好。技术博客、开源文档、电子书，背后基本都是 Markdown。（更多内容请参考：[附录：Markdown 文档](./markdown.md)）
...
很多人觉得用 AI 写长篇不靠谱，其实往往不是模型能力不行，而是缺少项目级的知识管理。写代码需要维护文档，写长篇也同样需要。
...
写完要让读者无障碍访问。传统建站需要购买 VPS、配置 Nginx、申请 SSL 证书。现代做法是 GitHub + Cloudflare Pages，全自动 CI/CD，零成本。
