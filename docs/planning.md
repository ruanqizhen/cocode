...
答案是：你必须在 AI 写下哪怕一行代码前，用一张清晰的战略地图来规范它的前进路线。 本章将系统介绍现代 AI 编程的核心方法论—— SPET 方法论（Spec - Plan - Execute - Test）。它不仅是拉开普通码农与“AI 架构师”的核心分水岭，更是将上一章的“上下文基础设施”串联到实际生产中的核心纽带。
...
- P (Planning / 实施计划)：理清“怎么做”与“分成几步做”。在动工前，利用 AI 强大的逻辑拆解能力，强制它把宏观大任务肢解为包含具体文件清单、验证手腕的详细实施步骤蓝图。
...
* 人类：在终端利落地敲下敲下：`git add . && git commit -m "feat: md-editor Step 1 completed"`。
