...
## 规则文件的生态学：.cursorrules、AGENTS.md 与 CLAUDE.md 的定位
...
## 落地完成标准（Definition of Done）：让 AI 懂得用退出码（Exit Code）交工
...
## 制定升级规则（Escalation Rules）：告诉 AI 陷入死循环时如何优雅地“求助”
...
## 复杂项目治理：Monorepo 中的目录级规则继承与隔离机制
